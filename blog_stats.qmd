...
I am responsible for all hits and misses. Feel free to contact me if you detect mistakes, misunderstandings, or ways to improve anything.
...
-   [Programación en `R`: indexación (versión en español)](https://rpubs.com/andresfeli/indexacion) (*`R` programming: Indexing [Spanish version]*)
-   [Programación en `R`: indexación (versión en portugués)](https://rpubs.com/andresfeli/indexacao) (*`R` programming: Indexing [Portuguese version]*)
...
-   [Inferencia estadística: estimación de parámetros](https://rpubs.com/andresfeli/est_pars) (*Statistical inference: estimating parameters*)

-   [Introducción a los modelos lineales generalizados (GLM I)](https://rpubs.com/andresfeli/glm_i) (*Introduction to generalized linear models (GLM)*)

-   [Introducción a los modelos jerárquicos I](https://rpubs.com/andresfeli/multilevel_I) (*Introduction to hierarchical models I*)

-   [Introducción a los modelos jerárquicos II](https://rpubs.com/andresfeli/multilevel_II) (*Introduction to hierarchical models II*)
...
-   [Clase UFPel (programa de postgrado en biodiversidad animal). *Programación en `R`*: Indexacion](https://rpubs.com/andresfeli/indexacion_UFPEL)

-   [Clase UFPel (programa de postgrado en biodiversidad animal). *Programación en `R`*: diseño muestral y exploración de tablas](https://rpubs.com/andresfeli/exploracion_tablas)
