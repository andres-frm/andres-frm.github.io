...
### Mechanims explaining temporal dynamics of seed dispersal networks in island ecosystems (2025-current)

![](photos/bat_network_posterior.gif){fig-align="center" width="275" group="my-gallery"}
![](photos/time_series.jpg){fig-align="center" width="350" group="my-gallery"}

Ecological communities are dynamic organizations of organisms whose structure is function of environmental and biological cycles affecting species composition and abundance. Such ecological regularities affects species interactions due to changes on the availability of suitable interaction partners, which ultimately impacts ecological processes in which the species are involved. We know little about the temporal dynamic of species interactions, and we lack mechanistic understanding on how climatic regularities interact with biological responses of the species to explaing the structure of ecological networks. In this project we use seed dispersal interaction networks in Hawaii islands

\

### Biotic and abiotic drivers of the structure of non-trophic interaction networks in tropical forest (2024-current)
...
This research is part of my work at the [Ecological Interactions Lab](https://sites.google.com/site/vizentinbugoni/) led by [Jef Vizentin-Bugoni](https://sites.google.com/site/vizentinbugoni/home/people).
