...
title: "About me"
resources:
  - photos/frugivory_banner.jpg
---

::: {.page-banner style="background-image: linear-gradient(to bottom, rgba(30,32,15,0) 45%, rgba(30,32,15,0.7) 100%), url('photos/frugivory_banner.jpg'); background-position: center 12%;"}
<div class="page-banner-text">
<h1>Andrés F. Ramírez-Mejía</h1>
<p>Ecologist — species interactions, ecosystem processes &amp; ecological modeling</p>
</div>
:::

### Hi!

I'm a postdoctoral researcher at the [Ecological Interactions Lab](https://sites.google.com/site/vizentinbugoni/) led by [Dr. Jef Vizentin-Bugoni](https://sites.google.com/site/vizentinbugoni/home/people) (Institute of Biology, UFPel) in Pelotas (RS), Brazil. I was born in Colombia and started my career hoping to become an agronomist, but somehow I ended up as a biologist interested in community ecology, species interactions, ecosystem processes, and ecological modeling.
