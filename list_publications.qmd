...
:::{}
-   **Ramírez-Mejía A. F.**, Mary De Aquino, Jeferson Vizentin-Bugoni, J. Patrick Kelley, Corey E. Tarwater, Henry S. Pollock, Juliana Wolter. Structure of army-ant-following birds interaction networks is modulated by cumulative rainfall and ant swarm at different temporal scales. **Role: first author**
-   **Ramírez-Mejía A. F.** Rarity and commonness in Neotropical bats: the role of the environment and species-level hypervolume niche. **Role: first author**
