...
:::{}
-   **Ramírez-Mejía A. F.**, Chacoff N., Cavigliasso P., Blendinger P., How much is enough? Optimizing beehive stocking densities to maximize the production of a pollinator-dependent crop. **Role Main author**
-   **Ramírez-Mejía A. F.**, ... Chacoff N. Low opportunity cost areas in large-scale monoculture for pollinator conservation. **Role: Main author**
-   Monasterologo, M, **Ramírez-Mejía A. F.**, et al. Animal pollination contributes to more than half of Citrus spp. production despite the species and cultivar. **Role: coauthor, data analysis**
