...
:::{}
-   How much is enough? Optimizing beehive stocking densities to maximize the production of a pollinator-dependent crop. **Role Main author**
-   Low opportunity cost areas in large-scale monoculture for pollinator conservation. **Role: Main author**
-   Pollination of *Citrus* spp. crops in Argentina. **Role: coauthor, data analysis**
-   Optimizing measumeremt effort in taxonomic studies on Formicidae. **Role: coauthor, data analysis**
-   Morphometrics as a tool for understanding morphological variation and supporting taxonomic decisions in *Prionopelta* Mayr, 1866. **Role: coauthor, data analysis**
:::
