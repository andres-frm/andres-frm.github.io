...
-   Juliana Wolter ... **Ramírez-Mejía A. F.**..., Rafael Dias. Intrinsic and extrinsic driversshape frugivore functional diversity within a tree population. *Journal: Ecosphere*. **Role: coauthor, data analysis**
...
-   **Ramírez-Mejía A. F.**, Francisco Sánchez, J. Nicolás Urbina-Cardona & Natalia Ladino. Morphological traits and intraspecific functional hypervolume drive the prevalence of low-abundance species in bat assemblages?. **Role: first author**
...
-  **Andrés F. Ramírez-Mejía**, Corey E. Tarwater, J. Patrick Kelley, Jinelle Sperry, Jeff Foster, Donald R. Drake, J., & Jeferson Vizentin-Bugoni. Temporal dynamics of seed-dispersal networks: Disentangling the role of direct biotic and abiotic factors and bottom-up processes. **Role: first author**
:::
